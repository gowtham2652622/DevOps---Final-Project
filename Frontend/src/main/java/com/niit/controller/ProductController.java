...
public class ProductController {
	...
	public String addProduct(@ModelAttribute("product") Product product,
			@RequestParam("productImage") MultipartFile productImage, Model m, BindingResult result) {

		productDAO.addProduct(product);

		String imagePath = "C:\\Users\\Gowtham\\workspace\\Eclipse_Workplace\\Frontend\\src\\main\\webapp\\resources\\images\\";
	...
	public String updateProduct(@RequestParam("productID") int productID,
			...
			@RequestParam("price") int price, @RequestParam("quantity") int stock, Model m) {
